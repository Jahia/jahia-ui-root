...
TEST_URL="http://localhost:8080" JAHIA_USERNAME="root" JAHIA_PASSWORD="root" yarn tests:integration adminMenuOrder --ci --runInBand --reporters=default --reporters=jest-junit
